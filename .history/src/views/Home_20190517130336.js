...
class Home extends React.Component {
  ...
  getProduct(){
    odoo.connect(function (err) {
        ...
        inParams.push(["display_name", "list_price", "price", "pos_categ_id", "taxes_id", "barcode", "default_code", "to_weight", "uom_id", "description_sale", "description", "product_tmpl_id", "tracking"]); //fields
